...
import type { RomInspectionResult } from './inspect.js';
...
export function writeRomInspection(outputDir: string, inspection: RomInspectionResult) {
...
export function printRomInspectionSummary(inspection: RomInspectionResult) {
  console.log('\n=== ROM INSPECT ===\n');
