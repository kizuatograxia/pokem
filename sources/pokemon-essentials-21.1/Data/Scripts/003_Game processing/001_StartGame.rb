...
module Game
  ...
  def self.start_new
    ...
    start_map_id, start_x, start_y, start_direction = Settings::NEW_GAME_START_POSITION
    $map_factory = PokemonMapFactory.new(start_map_id)
    ...
    $game_map.autoplay
    $game_map.update
    RecentLegendaryBundle.grant_immediately! if defined?(RecentLegendaryBundle)
  end
