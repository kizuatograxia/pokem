...
const mode = process.argv[3] || "command";
const outputPath = path.join(repoRoot, ".shard", "test", `quick-battle-${mode}.json`);
const screenshotPath = path.join(repoRoot, ".shard", "test", `quick-battle-${mode}.png`);
